      ...
      <BaseLayout>
        ...
        <div className="Certificate-Layout">
          ...
          <div className="Certificate-Layout-Header">
            <Link route={`/`}><a className='Home-Button'>Myanmar Blockchain</a></Link>
            ...
            <h1 className="Cert-of-Certificate-Title">Certificate Of Blockchain</h1>
            
            <div className="Cert-of-Certificate-Subtitle">Your Certificate on the blockchain</div>
          </div>
